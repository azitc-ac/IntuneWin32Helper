...
> **Moved.** This tool now lives in the [**intune-tools**](https://github.com/azitc-ac/intune-tools)
> repository, one folder per tool:
> [azitc-ac/intune-tools/IntuneWin32Helper](https://github.com/azitc-ac/intune-tools/tree/main/IntuneWin32Helper).
> Further development happens there; this repository is kept for its history only.
